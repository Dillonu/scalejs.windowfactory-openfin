define([
	...
	function getVisibleApplicationWindows() {
		var visibleWindows = [];
		
        for (var index = 0; index < applicationWindows.length; index += 1) {
            if (applicationWindows[index].isVisible()) visibleWindows.push(applicationWindows[index]);
        }
